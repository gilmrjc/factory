...
description: >-
  Construye un research brief desde un ticket. Úsalo cuando el usuario pida preparar el contexto de implementación o revisión de un ticket,
  y no para escribir código, commits o PR. Usa subagentes en paralelo para investigación de tareas, documentación y codebase.
  Escribe el brief en disco o lo entrega en chat. No puntúa calidad del ticket (usa ticket-review), no implementa código ni abre PR.
