...
- Grep scan corrido; cada hit listado con referencia de línea (o documentado cero hits)
...
Para cada hit grep partial o fail, agrega hallazgo important con reemplazo directo listo para pegar. Tres o más hits fail — impacto en puntuación per [scoring-rubric.md](./scoring-rubric.md).
