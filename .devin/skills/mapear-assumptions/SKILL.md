...
description: >-
  Mapea assumptions en 4 buckets (desirability, viability, feasibility, usability)
  usando framework de David Bland. Genera matriz 2x2 (risk vs evidence) y prioriza
  assumptions de alto riesgo/baja evidencia. Salida:
