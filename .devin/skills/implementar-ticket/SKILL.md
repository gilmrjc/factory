...
description: >-
  Orquesta el pipeline completo para implementar un ticket del repositorio, encadenando los skills de revisión, brief, triage, planificación, implementación, verificación y revisión de PR.
  Escribe artefactos puntuados en disco o los entrega en chat. No hace push a menos que se le pida.
  Úsalo cuando el usuario pida implementar un ticket de extremo a extremo siguiendo el proceso del repo, o reanudar trabajo de ticket con artefactos parciales —
  a menos que un plan de implementación puntuado (≥9, Ready for=implement) ya exista en disco. No para revisión de PR.
