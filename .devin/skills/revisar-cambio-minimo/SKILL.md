...
description: >-
  Revisión rápida de cambios mínimos (1 punto Fibonacci: 0-3 horas) con checklist
  simplificado. Valida: funcionalidad, tests, documentación básica, sin breaking
  changes. Salida: OK para merge o recomendaciones. Úsalo después de
  validar-tarea-trivial para fast-track approvals (5-10 min vs 30-60 min).
