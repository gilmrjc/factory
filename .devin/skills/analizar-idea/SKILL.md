...
description: >-
  ...
  sin mencionar solución. Evalúa alineación estratégica, urgencia, disponibilidad
  de recursos y genera recomendación Proceder/Proceder condicional/No proceder.
  Salida: docs/<domain>/idea/<IDEA-SLUG>/idea-analysis.md. Úsalo como gate
  preliminar de viabilidad antes de evaluar-alcance-idea. Solo análisis: no
  implementa, no
  aprueba, no evalúa alcance (usa evaluar-alcance-idea). Para implementación usa
  implementar-plan o implementar-ticket.
