...
description: >-
  Evalúa si una idea contiene múltiples funcionalidades o una sola funcionalidad.
  Divide ideas complejas en funcionalidades individuales con alcance, value
  proposition y timeline. Salida: docs/<domain>/idea/<IDEA-SLUG>/scope-roadmap.md.
  Úsalo después de analizar-idea y antes de priorizar-roadmap. Solo análisis de
  alcance: no evalúa viabilidad preliminar
  (usa analizar-idea) ni prioriza (usa priorizar-roadmap).
