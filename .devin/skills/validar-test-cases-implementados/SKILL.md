---
name: validar-test-cases-implementados
description: >-
  Compara los test cases sugeridos en el análisis de test cases con los tests
  implementados. Valida cobertura de happy path, edge cases, error cases, etc.
  Identifica gaps de cobertura y genera recomendaciones. Salida:
  docs/<domain>/<TICKET-ID>-test-coverage-validation.md con matriz de implementación.
  Úsalo después de implementar-plan para validar que los tests sugeridos se implementaron.
...
Si el archivo no existe, genera test cases sugeridos primero invocando `sugerir-test-cases`.
