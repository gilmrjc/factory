...
description: >-
  ...
  aceptación y secuencia de implementación. Salida: docs/<domain>/initiatives/<PRD-SLUG>/epics/epic-plan.md.
  Úsalo cuando el usuario pida planificar, diseñar, estructurar o descomponer
  iniciativas grandes en epics. No lo usas para dividir epics en tareas atómicas
  (usar dividir-epic) ni para validar viabilidad técnica específica (usar
