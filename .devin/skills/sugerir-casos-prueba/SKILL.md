...
description: >-
  ...
  faltantes: happy path, edge cases, error conditions y security tests. Genera
  checklist de test cases a implementar. Salida: docs/<domain>/<TICKET-ID>-test-cases.md.
  Úsalo cuando el usuario pida sugerir, identificar o proponer casos de prueba
  antes de implementar. No lo usas para validar que tests sugeridos se
  implementaron (usar validar-casos-prueba-implementados).
