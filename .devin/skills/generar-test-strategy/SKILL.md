---
name: generar-test-strategy
description: >-
  Genera una estrategia completa de testing usando la metodología ZOMBIE
  (Zero-bugs, One path, Many tests, Behavior-driven, Isolated, Exact).
  Salida: docs/<domain>/<EPIC-SLUG>-test-strategy.md con matriz de cobertura,
  casos de prueba por componente, datos de test y validaciones. Úsalo después
  de generar-arquitectura para definir testing antes de implementar.
argument-hint: "[EPIC-SLUG | ARCHITECTURE-RUTA]"
allowed-tools:
  - read
  - grep
  - find_file_by_name
