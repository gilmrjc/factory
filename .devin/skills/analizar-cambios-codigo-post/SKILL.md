---
name: analizar-cambios-codigo-post
description: >-
  Orquestador que ejecuta análisis post-implementación de cambios de código:
  detecta documentación faltante, valida impacto real vs predicho, valida test cases
  implementados. Ejecuta detectar-documentacion-faltante → validar-impacto-real →
  validar-test-cases-implementados en secuencia y genera resumen consolidado.
  Úsalo después de revisar-cambios-locales como gate de calidad final antes de crear PR.
...
# Analizador de Cambios de Código Post-Implementación (Orquestador)
...
3. `validar-test-cases-implementados` → Validar que los tests sugeridos se implementaron
...
1. Invoca `validar-test-cases-implementados` con entrada
