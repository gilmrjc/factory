...
description: >-
  Compara los casos de prueba sugeridos en el análisis de test cases con los tests implementados validando cobertura de happy path, edge cases, error cases, etc. para identificar gaps de cobertura y generar recomendaciones en docs/<domain>/<TICKET-ID>-test-coverage-validation.md con matriz de implementación. Úsalo cuando el usuario pida validar, comparar, verificar, revisar, auditar o evaluar la cobertura de tests después de implementar-plan. No lo uses para sugerir test cases antes de implementar — usa sugerir-casos-prueba para eso.
