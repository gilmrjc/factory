...
2. Aplica correcciones en cambios locales pequeños. Coincide con convenciones en archivos hermanos. Cubre regresiones con tests dirigidos (`./scripts/docker-helper.sh test -m unit`, ejecutar tests específicos del frontend según AGENTS.md). Nunca ejecutes el suite completo.
