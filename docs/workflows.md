...
Este documento es el mapa de ruta para operar el proceso de producto→código del proyecto Alejandria mediante la librería de skills. Úsalo para saber en qué punto del proceso estás, qué skill sigue, y si conviene invocar un orquestador end-to-end o skills individuales a mano.
...
flowchart LR
    ...
    subgraph WF4["4. Ejecución de Implementación"]
        ...
        I3 --> I4[analizar-cambios-código-post]
    end
